...
const ServiceOffered = () => {
    ...
    const data = useStaticQuery(
        graphql`
    query {
    allContentfulService(filter: {mainService: {eq: true}}) {
        edges {
        node {
            name
            description
        ...
        >
            <TitleContainer>
                <TitleWrapper>
                    ...
                    <SubPara>You can be provided to build your unique ideas by converting them into elegant designs, awesome experiences and catchy brands.</SubPara>
                </TitleWrapper>
            </TitleContainer>
