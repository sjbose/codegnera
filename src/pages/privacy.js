...
const Privacy = () => {
    return (
        <Container>
            ...
            <h3>Codegenera may disclose your Personal Data in the good faith belief that such action is necessary to:</h3>
            <p>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of codegenera</li>
                <li>To prevent or investigate possible wrongdoing in connection with the Service</li>
                <li>To protect the personal safety of users of the Service or the public</li>
                <li>li To protect against legal liability</li>
            </p>
            ...
            <h2>Contact Us</h2>
            <p>
                If you have any questions about this Privacy Policy, please contact us by visit:<br />
                <a href="https://www.codegenera.in/contact">https://www.codegenera.in/contact</a>
            </p>
        </Container>
    )
}
